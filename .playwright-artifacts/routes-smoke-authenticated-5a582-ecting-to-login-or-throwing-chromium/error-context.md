...
- Name: routes-smoke.spec.ts >> authenticated route crawl >> /automation loads without redirecting to /login or throwing
- Location: e2e\routes-smoke.spec.ts:24:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8888/automation
Call log:
  - navigating to "http://localhost:8888/automation", waiting until "load"
