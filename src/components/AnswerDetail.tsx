...
/** One answered "Quick Answers" turn — summary, an optional derived CTA, and collapsed evidence. Shared by `Intelligence.tsx` and `AskOrbitPanel`. */
  ...
  return (
    <div style={{ marginTop: 10 }}>
      <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
        {/* `zap`, not `sparkles` — this app's sparkles icon means "real AI"
            (Ask AI, Intelligence nav); these are canned, deterministic
            answers, not a model response, and shouldn't look like one. */}
        <span style={{ color: "var(--mint)", flexShrink: 0, marginTop: 2 }}><Icon name="zap" size={14} /></span>
